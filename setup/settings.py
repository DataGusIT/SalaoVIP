...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'notificacoes.context_processors.contador_notificacoes', 
            ],
        },
    },
]
...
# Uploads de Mídia (Fotos de perfil)
MEDIA_URL = '/media/'
...
if DEBUG:
    ...
    # Configuração Padrão do Django (Sistema de Arquivos)
    STORAGES = {
        "default": {
...
# Se estivermos em Produção (Render)
else:
    # Configurações do Supabase / AWS S3
